...
<html>
    <head>
        ...
        <title>
            Mendo Junior Web developer testa uzdevums
        </title>
        </head>
        <body>
            <h1 align ="center"> Uzdevums - CV ģenerēšanas forma!</h1>
            <div class = "container">
            <!-- Pamatinformācijas bloks -->
                <div class = "main">
                    <form id="form" action = "app/controllers/controller.php" method="POST" enctype="multipart/form-data">
                        ...
                        <label>Piem.-Homērs</label>
                        <input type ="text" class ="main-surename__input" name="surename" placeholder="Ievadiet Jūsu uzvārdu" required>
                        <label>Piem.-Simpsons</label>
                        <input type ="date" class ="main-bdate__input" name="bdate" min="1930-01-01" max="2006-01-01" required>
                        <label>Piem.-12.05.1956</label>
